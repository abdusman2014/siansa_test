...
const dataset = DatasetsConstants.USER_ROLES_DATASET;

String dataNameSG = 'User Role';
String dataNamePL = 'User Roles';
// - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
class UserRoleCRUDProvider with ChangeNotifier {
  final UserRoleProvider userRoleProvider;

  UserRoleCRUDProvider(this.userRoleProvider);
