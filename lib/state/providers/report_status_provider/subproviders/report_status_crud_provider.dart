...
String dataNameSG = 'Report Status';
String dataNamePL = 'Report Statuses';
// - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
class ReportStatusCRUDProvider with ChangeNotifier {
  final ReportStatusProvider reportStatusProvider;

  ReportStatusCRUDProvider(this.reportStatusProvider);
