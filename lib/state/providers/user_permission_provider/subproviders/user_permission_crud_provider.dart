...
String dataNameSG = 'User Permission';
String dataNamePL = 'User Permissions';
// - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
class UserPermissionCRUDProvider with ChangeNotifier {
  final UserPermissionProvider userPermissionProvider;

  UserPermissionCRUDProvider(this.userPermissionProvider);
