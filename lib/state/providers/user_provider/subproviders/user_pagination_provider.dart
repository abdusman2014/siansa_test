...
const dataset = DatasetsConstants.USERS_DATASET;

const String orderBy = 'email'; // 'createdAt' or 'id'
const int docsPerPage = 10;
const bool descending = false; // ASC: 1-10, A-Z | DESC: 10-1, Z-A
// - - - - - - - - - - - - - - - - - - - - - - - - - - -

class UserPaginationProvider with ChangeNotifier {
  final UserProvider userProvider;

  UserPaginationProvider(this.userProvider);
