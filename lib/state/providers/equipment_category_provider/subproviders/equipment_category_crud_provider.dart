...
const dataset = DatasetsConstants.EQUIPMENT_CATEGORIES_DATASET;

String dataNameSG = 'Equipment Category';
String dataNamePL = 'Equipment Categories';
// - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
class EquipmentCategoryCRUDProvider with ChangeNotifier {
  final EquipmentCategoryProvider equipmentCategoryProvider;

  EquipmentCategoryCRUDProvider(this.equipmentCategoryProvider);
