...
const dataset = DatasetsConstants.REPORT_CATEGORIES_DATASET;

String dataNameSG = 'Report Category';
String dataNamePL = 'Report Categories';
// - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
class ReportCategoryCRUDProvider with ChangeNotifier {
  final ReportCategoryProvider reportCategoryProvider;

  ReportCategoryCRUDProvider(this.reportCategoryProvider);
