...
const dataset = DatasetsConstants.REPORTS_DATASET;

const String orderBy = 'createdAt'; // 'createdAt' or 'id'
const int docsPerPage = 5;
const bool descending = false; // ASC: 1-10, A-Z | DESC: 10-1, Z-A
// - - - - - - - - - - - - - - - - - - - - - - - - - - -

class ReportPaginationProvider with ChangeNotifier {
  final ReportProvider reportProvider;

  ReportPaginationProvider(this.reportProvider);
