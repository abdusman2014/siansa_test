...
const dataset = DatasetsConstants.REPORT_TEMPLATES_DATASET;

String dataNameSG = 'Report Template';
String dataNamePL = 'Report Templates';
// - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
class ReportTemplateCRUDProvider with ChangeNotifier {
  final ReportTemplateProvider reportTemplateProvider;

  ReportTemplateCRUDProvider(this.reportTemplateProvider);
