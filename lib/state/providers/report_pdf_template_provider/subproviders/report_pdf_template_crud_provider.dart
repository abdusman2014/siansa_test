...
const dataset = DatasetsConstants.REPORT_PDF_TEMPLATES_DATASET;

String dataNameSG = 'Report PDF Template';
String dataNamePL = 'Report PDF Templates';
// - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
class ReportPDFTemplateCRUDProvider with ChangeNotifier {
  final ReportPDFTemplateProvider reportPDFTemplateProvider;

  ReportPDFTemplateCRUDProvider(this.reportPDFTemplateProvider);
