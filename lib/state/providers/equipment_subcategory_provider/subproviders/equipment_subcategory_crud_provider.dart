...
const dataset = DatasetsConstants.EQUIPMENT_SUBCATEGORIES_DATASET;

String dataNameSG = 'Equipment Subcategory';
String dataNamePL = 'Equipment Subcategories';
// - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
class EquipmentSubcategoryCRUDProvider with ChangeNotifier {
  final EquipmentSubcategoryProvider equipmentSubcategoryProvider;

  EquipmentSubcategoryCRUDProvider(this.equipmentSubcategoryProvider);
