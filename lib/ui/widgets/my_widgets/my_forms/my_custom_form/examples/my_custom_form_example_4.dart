...
import 'package:siansa_app/ui/widgets/my_widgets/my_forms/my_custom_form/form_layouts/form_layout_2.dart';
...
class MyCustomFormExample4 extends StatefulWidget {
  final Map<String, dynamic>? initialValues;
  final Function()? onClickForgotPassword;
  final Function(Map<String, dynamic>)? onSubmit;

  MyCustomFormExample4({
    Key? key,
    this.initialValues,
  ...
  @override
  State<MyCustomFormExample4> createState() => _MyCustomFormExample4State();
}

class _MyCustomFormExample4State extends State<MyCustomFormExample4> {
...
// shared actions triggered by all inputs when they changed
  ...
  Widget build(BuildContext context) {
    // return MyCustomFormLayout2();

    return FormBuilder(
      key: formKey,
      autovalidateMode: AutovalidateMode.onUserInteraction,
      child: MyCustomFormLayout2(
        // Show/Hide Rows
        row1ChildVisible: true,
        row2Column1ChildVisible: true,
        row2Column2ChildVisible: true,
        row3Column1ChildVisible: true,
        row3Column2ChildVisible: true,
        // Rows
        row1Child: Container(
        ...
        row3Column1Child: Container(
          color: Colors.white,
          padding: const EdgeInsets.all(16),
          child: const Text(
              'Add something here... perhaps a "go back" or "cancel" button or just a text like this?'),
        ),
        row3Column2Child: Container(
          color: Colors.white,
          padding: const EdgeInsets.all(16),
