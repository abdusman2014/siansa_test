...
import 'package:siansa_app/models/ui/forms/my_form_model.dart';
...
class MyForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
        ...
        child: Column(
          children: [
            if (titleText.toString().isNotEmpty) Text(titleText),
            if (subtitleText.toString().isNotEmpty) Text(subtitleText),
            if (descriptionText.toString().isNotEmpty) Text(descriptionText),
            buildInputElements(context, submitButtonText, onSubmit),
            if (footerText.toString().isNotEmpty) Text(footerText),
          ],
        ));
  }
