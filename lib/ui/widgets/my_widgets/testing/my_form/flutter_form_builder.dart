...
class FlutterFormBuilder extends StatefulWidget {
  ...
  final List<Map<String, dynamic>> inputElements;
...
class _FlutterFormBuilderState extends State<FlutterFormBuilder> {
  ...
  // Initialized with 0.00, change as needed.
  double _formattedDecimalValue = 0.00;
  ...
  Widget buildFormInput(Map<String, dynamic> inputElement) {
    ...
    switch (inputElement['type']) {
      ...
      case 'textfield':
        return FormBuilderTextField(
          ...
          validator: FormBuilderValidators.compose([
            if (inputElement['validationRules'] != null &&
                inputElement['validationRules'].contains('required'))
              FormBuilderValidators.required(),
            if (inputElement['validationRules'] != null &&
                inputElement['validationRules'].contains('maxLength100'))
        ...
        if (inputElement['options'] != null) {
          return FormBuilderFilterChip<dynamic>(
            ...
            options: inputElement['options']!
                ...
                //       child: Text(option['text'].toString()),
                //     ))
                .map<FormBuilderChipOption<dynamic>>(
          ...
          return FormBuilderChoiceChip<dynamic>(
            ...
            options: inputElement['options']!
                ...
                .map<FormBuilderChipOption<String>>(
                    (option) => FormBuilderChipOption<String>(
                          value: option['value'].toString(),
                          child: Text(option['text'].toString()),
                        ))
                .toList(),
      ...
      case 'dateRangePicker':
        return FormBuilderDateRangePicker(
          ...
          lastDate: inputElement['initialValue'] ?? _selectedDateRange.end,
          format: DateFormat('MM/dd/yyyy'),
          decoration: InputDecoration(
            labelText: inputElement['label'],
          ),
  ...
  void _handleOnSubmit(onSubmit) {
    ...
    onSubmit(savedAndValidatedValues, isFormValid);
  }
