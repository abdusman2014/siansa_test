// example_timelines/activity_timeline/activity_timeline.dart
...
class VerticalType1Timeline extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _VerticalType1Timeline();
  }
}

class _VerticalType1Timeline extends StatefulWidget {
  @override
  _VerticalType1TimelineState createState() => _VerticalType1TimelineState();
}

class _VerticalType1TimelineState extends State<_VerticalType1Timeline> {
  List<Step>? _steps;
