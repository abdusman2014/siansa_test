// example_timelines/football_timeline/football_timeline.dart

import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:timeline_tile/timeline_tile.dart';

class VerticalType3Timeline extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _VerticalType3Timeline();
  }
}

class _VerticalType3Timeline extends StatefulWidget {
  @override
  _VerticalType3TimelineState createState() => _VerticalType3TimelineState();
}

class _VerticalType3TimelineState extends State<_VerticalType3Timeline> {
...
class _TimelineFootballChild extends StatelessWidget {
  ...
  Widget _buildIconByAction(Action action) {
    final imageAsset =
        'assets/my_timeline/examples/football/${action.toString().split('.').last}.png';
    return Image.asset(
      imageAsset,
      height: 20,
      width: 20,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          Expanded(
              child: Image.asset(
                  'assets/my_timeline/examples/football/barcelona.png')),
          ...
          Expanded(
              child: Image.asset(
                  'assets/my_timeline/examples/football/arsenal.png')),
        ],
      ),
    );
  }
