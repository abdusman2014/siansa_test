// example_timelines/success_timeline/success_timeline.dart
...
class VerticalType4Timeline extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _VerticalType4Timeline();
  }
}

class _VerticalType4Timeline extends StatefulWidget {
  @override
  _VerticalType4TimelineState createState() => _VerticalType4TimelineState();
}

class _VerticalType4TimelineState extends State<_VerticalType4Timeline> {
    ...
    return SliverList(
      delegate: SliverChildBuilderDelegate(
        (BuildContext context, int index) {
          ...
          final StepItem step = steps![itemIndex];
