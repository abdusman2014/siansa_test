...
class VerticalType5Timeline extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _VerticalType5Timeline();
  }
}

class _VerticalType5Timeline extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Expanded(
      child: Container(
              ...
              body: ListView(
                children: <Widget>[
                  ...
                  _buildTimelineTile(
                    ...
                    temperature: '26°C',
                    phrase:
                        'A beautiful afternoon to take a walk into the park.'
