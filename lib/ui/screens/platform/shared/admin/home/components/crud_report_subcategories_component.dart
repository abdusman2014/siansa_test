...
import 'package:siansa_app/ui/screens/platform/shared/admin/home/widgets/form_report_subcategories_order_by.dart';
import 'package:siansa_app/ui/screens/platform/shared/admin/home/widgets/form_report_subcategories_save.dart';
import 'package:siansa_app/ui/screens/platform/shared/admin/home/widgets/form_report_subcategories_search_filter.dart';
...
const String dataset = DatasetsConstants.REPORT_SUBCATEGORIES_DATASET;
// - - - - - - - - - - - - - - - - - - - - - - - - - - -

class CRUDReportSubcategoriesComponent extends StatefulWidget {
  final String? authUserRoleId;

  const CRUDReportSubcategoriesComponent({
    Key? key,
    required this.authUserRoleId,
  }) : super(key: key);

  @override
  _CRUDReportSubcategoriesComponentState createState() =>
      _CRUDReportSubcategoriesComponentState();
}

class _CRUDReportSubcategoriesComponentState
    extends State<CRUDReportSubcategoriesComponent> {
  ...
  Future<void> _setInitialData() async {
    ...
    await reportSubcategoryProvider.pagination.getFirstPage(context: context);
    ...
    setState(() {
      _data =
          rowsDataFormat(reportSubcategoryProvider.pagination.paginationData);
  ...
  Widget build(BuildContext context) {
    // Get the ReportSubcategoryProvider to access pagination data and methods
    final reportSubcategoryProvider =
        Provider.of<ReportSubcategoryProvider>(context);
    // final reportSubcategoryData = reportSubcategoryProvider.reportSubcategory!.toMap();

    final String _dataTitle =
        AppLocalizations.of(context)!.reportSubcategoriesTXT;
    ...
    // Define previous and next page functions using the reportSubcategoryProvider's pagination methods
    Future<void> _getPreviousPage() async {
      await reportSubcategoryProvider.pagination
    ...
    Future<void> _getNextPage() async {
      await reportSubcategoryProvider.pagination.getNextPage(context: context);
      setState(() {
        _data =
            rowsDataFormat(reportSubcategoryProvider.pagination.paginationData);
      });
    ...
    return CrudComponent(
      ...
      onDelete: (String id) async {
        ...
        await reportSubcategoryProvider.crud.deleteOneById(context, id);
      ...
      createFormWidget: () => FormReportSubcategoriesSave(
        authUserRoleId: widget.authUserRoleId,
        initialValues: const {},
        reportCategoryOptions: _reportCategoryOptions,
        onSubmit: (data) async {
          print('FormReportSubcategoriesSave data');
          print(data);

          // Save data on database
          await reportSubcategoryProvider.crud.createOne(context, data);
      ...
      readContentWidget: (data) => FormReportSubcategoriesSave(
        authUserRoleId: widget.authUserRoleId,
        initialValues: data,
        reportCategoryOptions: _reportCategoryOptions,
        onSubmit: (data) {
      ...
      filterFormWidget: FormReportSubcategoriesSearchFilter(
        onSubmit: (data) {
          print('FormReportSubcategoriesSearchFilter data');
          print(data);
          Navigator.of(context).pop();
        },
      ),
      orderByFormWidget: FormReportSubcategoriesOrderBy(
        onSubmit: (value) {
          print('FormReportSubcategoriesOrderBy value');
          print(value);
          Navigator.of(context).pop();
        },
      ),
      updateFormWidget: (data) => FormReportSubcategoriesSave(
        authUserRoleId: widget.authUserRoleId,
        initialValues: data,
        reportCategoryOptions: _reportCategoryOptions,
        onSubmit: (data) async {
          ...
          // Save data on database
          await reportSubcategoryProvider.crud
