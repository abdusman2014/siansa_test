...
class FormReportTemplatesSearchFilter extends StatefulWidget {
  ...
  FormReportTemplatesSearchFilter({
    Key? key,
  ...
  @override
  State<FormReportTemplatesSearchFilter> createState() =>
      _FormReportTemplatesSearchFilterState();
}

class _FormReportTemplatesSearchFilterState
    extends State<FormReportTemplatesSearchFilter> {
