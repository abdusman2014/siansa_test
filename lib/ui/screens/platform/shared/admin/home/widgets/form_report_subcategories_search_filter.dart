...
class FormReportSubcategoriesSearchFilter extends StatefulWidget {
  ...
  FormReportSubcategoriesSearchFilter({
    Key? key,
  ...
  @override
  State<FormReportSubcategoriesSearchFilter> createState() =>
      _FormReportSubcategoriesSearchFilterState();
}

class _FormReportSubcategoriesSearchFilterState
    extends State<FormReportSubcategoriesSearchFilter> {
