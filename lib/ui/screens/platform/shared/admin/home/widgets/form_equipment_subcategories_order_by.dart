...
class FormEquipmentSubcategoriesOrderBy extends StatefulWidget {
  ...
  FormEquipmentSubcategoriesOrderBy({
    Key? key,
  ...
  @override
  State<FormEquipmentSubcategoriesOrderBy> createState() =>
      _FormEquipmentSubcategoriesOrderByState();
}

class _FormEquipmentSubcategoriesOrderByState
    extends State<FormEquipmentSubcategoriesOrderBy> {
