...
class FormUsersOrderBy extends StatefulWidget {
  ...
  FormUsersOrderBy({
    ...
    this.radioInputOptions = const [
      ...
      {'text': 'Last Name A-Z', 'value': 'lastname-asc'},
      {'text': 'Last Name Z-A', 'value': 'lastname-desc'},
      {'text': 'Email A-Z', 'value': 'email-asc'},
      {'text': 'Email Z-A', 'value': 'email-desc'},
      {'text': 'Phone 0-9', 'value': 'phone-asc'},
      {'text': 'Phone 9-0', 'value': 'phone-desc'},
    ],
    this.radioInputInitValue = 'name-asc',
  }) : super(key: key);

  @override
  State<FormUsersOrderBy> createState() => _FormUsersOrderByState();
}

class _FormUsersOrderByState extends State<FormUsersOrderBy> {
