...
class FormReportCategoriesSave extends StatefulWidget {
  ...
  @override
  State<FormReportCategoriesSave> createState() =>
      _FormReportCategoriesSaveState();
}

class _FormReportCategoriesSaveState extends State<FormReportCategoriesSave> {
  ...
  void initState() {
    ...
    // _validateForm();
    debugPrint(
        'FormReportCategoriesSave initialValues ${widget.initialValues}');
  }
