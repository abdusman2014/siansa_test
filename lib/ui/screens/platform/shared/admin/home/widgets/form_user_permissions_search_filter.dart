...
class FormUserPermissionsSearchFilter extends StatefulWidget {
  ...
  FormUserPermissionsSearchFilter({
    Key? key,
  ...
  @override
  State<FormUserPermissionsSearchFilter> createState() =>
      _FormUserPermissionsSearchFilterState();
}

class _FormUserPermissionsSearchFilterState
    extends State<FormUserPermissionsSearchFilter> {
