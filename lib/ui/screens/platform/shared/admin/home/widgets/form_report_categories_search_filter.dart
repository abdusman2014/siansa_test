...
class FormReportCategoriesSearchFilter extends StatefulWidget {
  ...
  FormReportCategoriesSearchFilter({
    Key? key,
  ...
  @override
  State<FormReportCategoriesSearchFilter> createState() =>
      _FormReportCategoriesSearchFilterState();
}

class _FormReportCategoriesSearchFilterState
    extends State<FormReportCategoriesSearchFilter> {
