...
class FormUserRolesSave extends StatefulWidget {
  final String? authUserRoleId;

  final List<Map<String, dynamic>>? userPermissionOptions;
  ...
  @override
  State<FormUserRolesSave> createState() => _FormUserRolesSaveState();
}

class _FormUserRolesSaveState extends State<FormUserRolesSave> {
  ...
  List<dynamic>? _userPermissionIdsInputValue;
  ...
  void initState() {
    ...
    // _validateForm();
    debugPrint('FormUserRolesSave initialValues ${widget.initialValues}');
  }
  ...
  void _populateInitialValues() {
    if (widget.initialValues != null) {
      ...
      _userPermissionIdsInputValue = initialValues?['userPermissionIds'] ?? [];
  ...
  void _validateForm() {
    ...
    setState(() {
      ...
      if (_userPermissionIdsInputValue == null ||
          _userPermissionIdsInputValue!.isEmpty) {
        invalidInputs.add("User Permission Ids");
      }
  ...
  Map<String, dynamic> _getFormValues() {
    return {
      ...
      'userPermissionIds': _userPermissionIdsInputValue,
      ...
      child: MyCustomFormLayout1B(
        ...
        row2Column2Child: Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              _buildLabel('Select User Permissions'),
              _buildUserPermissionsCheckboxGroupInput(),
            ],
          ),
        ),
  ...
  _buildUserPermissionsCheckboxGroupInput() {
    return MyCustomFormCheckboxGroupInput(
      ...
      name: 'User Roles',
      options: widget.userPermissionOptions!,
      initialValues: _userPermissionIdsInputValue,
      onChanged: (values) {
        setState(() {
          _userPermissionIdsInputValue = values;
        });
