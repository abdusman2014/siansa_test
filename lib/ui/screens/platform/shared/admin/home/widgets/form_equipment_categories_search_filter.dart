...
class FormEquipmentCategoriesSearchFilter extends StatefulWidget {
  ...
  FormEquipmentCategoriesSearchFilter({
    Key? key,
  ...
  @override
  State<FormEquipmentCategoriesSearchFilter> createState() =>
      _FormEquipmentCategoriesSearchFilterState();
}

class _FormEquipmentCategoriesSearchFilterState
    extends State<FormEquipmentCategoriesSearchFilter> {
