...
class FormEquipmentSubcategoriesSave extends StatefulWidget {
  ...
  FormEquipmentSubcategoriesSave({
    Key? key,
    //
  ...
  @override
  State<FormEquipmentSubcategoriesSave> createState() =>
      _FormEquipmentSubcategoriesSaveState();
}

class _FormEquipmentSubcategoriesSaveState
    extends State<FormEquipmentSubcategoriesSave> {
  ...
  void initState() {
    ...
    // _validateForm();
    debugPrint(
        'FormEquipmentSubcategoriesSave initialValues ${widget.initialValues}');
  }
