...
class FormEquipmentSubcategoriesSearchFilter extends StatefulWidget {
  ...
  FormEquipmentSubcategoriesSearchFilter({
    Key? key,
  ...
  @override
  State<FormEquipmentSubcategoriesSearchFilter> createState() =>
      _FormEquipmentSubcategoriesSearchFilterState();
}

class _FormEquipmentSubcategoriesSearchFilterState
    extends State<FormEquipmentSubcategoriesSearchFilter> {
