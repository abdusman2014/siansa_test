...
class FormReportPDFTemplatesSave extends StatefulWidget {
  ...
  @override
  State<FormReportPDFTemplatesSave> createState() =>
      _FormReportPDFTemplatesSaveState();
}

class _FormReportPDFTemplatesSaveState
    extends State<FormReportPDFTemplatesSave> {
  ...
  late final TextEditingController _pdfTemplateCodeTextController;
  ...
  String? _pdfTemplateCodeInputValue;
  ...
  void initState() {
    ...
    // _validateForm();
    debugPrint(
        'FormReportPDFTemplatesSave initialValues ${widget.initialValues}');
  }
  ...
  void _initializeControllers() {
    ...
    _pdfTemplateCodeTextController = TextEditingController();
  }

  void _disposeControllers() {
    _idTextController.dispose();
    _nameTextController.dispose();
    _pdfTemplateCodeTextController.dispose();
  }
  ...
  void _validateForm() {
    ...
    setState(() {
      ...
      if (validate.isRequiredFieldOk(_pdfTemplateCodeTextController.text) !=
              true ||
          validate.isRequiredFieldOk(_pdfTemplateCodeInputValue) != true) {
        invalidInputs.add("PDF Template Code");
      }
  ...
  Map<String, dynamic> _getFormValues() {
    return {
      ...
      'code': _pdfTemplateCodeInputValue,
      ...
      child: MyCustomFormLayout1B(
        ...
        row2Column2Child: Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              _buildLabel('PDF Template Code'),
              _buildPDFTemplateCodeTextAreaInput(),
            ],
          ),
        ),
  ...
  _buildPDFTemplateCodeTextAreaInput() {
    return MyCustomFormTextareaInput(
      isDisabled: widget.areInputsDisabled,
      controller: _pdfTemplateCodeTextController,
      inputKey: 'pdf_template_code_textarea',
      name: 'pdf_template_code_textarea',
      initialValue: _pdfTemplateCodeInputValue!,
      // hintText: AppLocalizations.of(context)!.descriptionTXT,
      hintText: 'Enter HTML code here...',
      validator: (value) {
        dynamic requiredFieldValidation = Validation().isRequiredFieldOk(value);
        if (requiredFieldValidation != true) return requiredFieldValidation;
        return null;
      ...
      onChanged: (value) {
        setState(() {
          // _pdfTemplateCodeInputValue = _pdfTemplateCodeTextController.text;
          _pdfTemplateCodeInputValue = value;
        });
        _actionsOnInputChanged(value);
      },
      // EDIT STYLES -*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
