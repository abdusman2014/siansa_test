...
class FormEquipmentCategoriesSave extends StatefulWidget {
  ...
  @override
  State<FormEquipmentCategoriesSave> createState() =>
      _FormEquipmentCategoriesSaveState();
}

class _FormEquipmentCategoriesSaveState
    extends State<FormEquipmentCategoriesSave> {
  ...
  void initState() {
    ...
    // _validateForm();
    debugPrint(
        'FormEquipmentCategoriesSave initialValues ${widget.initialValues}');
  }
