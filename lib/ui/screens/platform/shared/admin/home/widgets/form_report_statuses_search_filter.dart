...
class FormReportStatusesSearchFilter extends StatefulWidget {
  ...
  FormReportStatusesSearchFilter({
    Key? key,
  ...
  @override
  State<FormReportStatusesSearchFilter> createState() =>
      _FormReportStatusesSearchFilterState();
}

class _FormReportStatusesSearchFilterState
    extends State<FormReportStatusesSearchFilter> {
