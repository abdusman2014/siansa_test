...
class FormEquipmentOrderBy extends StatefulWidget {
  ...
  @override
  State<FormEquipmentOrderBy> createState() => _FormEquipmentOrderByState();
}

class _FormEquipmentOrderByState extends State<FormEquipmentOrderBy> {
