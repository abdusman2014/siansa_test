...
class FirebaseFirestorePaginationService {
  ...
  //     initialQuery = queryFiltersHelper(
  //       initialQuery,
  //       equalityFilters,
  //       inFilters,
  //       rangeFilters,
  ...
  //     return await queryResultsHelper(query: initialQuery);
  //   }

  //   // List to hold queries for each search field
  //   List<Future<QuerySnapshot>> queries = [];

  //   for (String field in searchFields) {
  //     Query individualQuery = _firestore
  //         .collection(collectionName)
  //         .where(field, isEqualTo: searchTerm)
  //         .orderBy(orderBy, descending: descending)
  //         .limit(docsPerPage);

  //     // Apply other filters to each query
  //     individualQuery = queryFiltersHelper(
  //       individualQuery,
  //       equalityFilters,
  //       inFilters,
  //       rangeFilters,
  ...
  //     queries.add(individualQuery.get());
  //   }

  //   // Execute all queries in parallel and await results
  //   List<QuerySnapshot> querySnapshots = await Future.wait(queries);
  ...
  Future<Map<String, dynamic>> firstPageQuery({
    ...
    print('\n\n>>>>> lowercaseSearchTerm <<<<<\n\n');
    print(lowercaseSearchTerm);

    // add where clauses to the query
    for (String field in searchFields) {
      // print('\n\n>>>>> field <<<<<\n\n');
      // print(field);
      // query = query.where(field, isEqualTo: searchTerm.toLowerCase());
    ...
    filteredDocuments.map((doc) => doc.data()).toList();
